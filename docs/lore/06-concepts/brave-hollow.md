...
The Brave + Hollow is packaged in a festive box that includes:
1 x Hard plastic Brave + Hollow figure
1 x Hard plastic scenic base insert
1 x Hard plastic Kingdom Death 30mm base
1 x Large matte art print
1 x Living Glossary card
3 x Seed pattern gear cards
3 x Seed pattern cards. Rules for Seed Patterns in your campaign are available here.
