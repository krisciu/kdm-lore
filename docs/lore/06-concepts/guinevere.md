...
Artwork: Lokman LamSculpture: Team Death
Guinevere is packaged in a graphic box that includes:
1 x Guinevere plastic miniature
1 x Hard plastic Kingdom Death 30mm base and insert
1 x Challenger character card
1 x Character card install guide
